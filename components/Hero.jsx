...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    bounceTl.to(imageRef.current, { x: 100, ease: 'power1.inOut', duration: 1 },0.1);
  ...
  return (
    <div className='flex items-center justify-center w-[100%] h-[100vh] flex-col overflow-hidden font-mori' ref={heroContainer}>
      <div>
      ...
      <div className="flex overflow-hidden translate-x-4" >
        <h3 className='text-2xl opacity-100' ref={t3}>Student, Optimist, <span className='text-blue-400'>Developer</span> </h3 >
      </div>
      </div>
    </div>
  );
